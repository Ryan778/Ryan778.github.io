...
editor.ui.addButton("checkTextButton",{label:"Check Text",command:"ct",toolbar:"others",icon:"//50.155.208.17:8081/sobvc/highlighter.png"});function checkForQuote(a){var b=0,c=0;if(quotePos.start[c]>a)return!1;for(;a>=quotePos.start[c]&&c<=quotePos.start.length;)b=c,c++;return a<=quotePos.end[b]?!0:!1}
