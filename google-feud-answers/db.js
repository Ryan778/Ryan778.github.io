var lastUpdate = "February 2021",
  db = {
    ...
    "i didn't get the movie": ["us", "hereditary", "open house"],
    "movies written by": [
      "quentin tarantino",
      "women",
      "sylvester stallone",
    ...
    "friends episode the one with the": ["ball", "trifle", "list"],
    ...
    "what are the chances of another": ["ice age", "earth"],
    "cheese stuffed": [
      "chicken breast",
      "shells",
      "meatloaf",
    ...
    "why does california have so many": ["fires", "laws"],
    "why does the us have so many": ["tornadoes", "nukes", "states", "banks"],
    "can you eat wild": [
      "boar",
      "hogs",
      "turkey",
    ...
    "is there a word that rhymes with": [
      "orange",
      "purple",
      "pint",
      "wolf",
    ...
    "can you toast a": [
      "bagel in an air fryer",
      "bagel in the oven",
      "bagel in the microwave",
      "frozen bagel",
      "bagel on the stove",
      "rice cake",
      "croissant",
    ...
    "what would happen if you touched": ["lava", "a star"],
    "tips for new": [
      "drivers",
      "moms",
      "puppy owners",
    ...
    "mr.": [
      ...
      "mayor",
      "beast",
      "coffee iced coffee maker",
      "iglesias",
      "heater",
      "bean",
      "t",
      "beast burger location",
    ],
    coconut: [
      "oil",
      "aminos",
    ...
    "island of": [
      ...
      "the blue dolphins",
      "misfit toys",
      "hawaii crossword clue",
      "hawaii",
      "the dolls",
      "dr moreau",
      "misfit toys characters",
      "patmos",
      "sao miguel",
    ],
    "famous celebrity": [
    ...
    "kale is": [
      ...
      "high in what nutrients",
      "a vegetable",
      "good for diabetes",
      "rich in",
      "a variety of which vegetable",
    ],
    "cursive is": [
      "obsolete",
      "pointless",
    ...
    "never put a": [
      "question mark where god",
      "hat on your bed",
      "sock in a toaster meaning",
      "man before your child",
      "knife to basil",
      "blade in the ground meaning",
      "car battery on the ground",
      "blade in the ground",
      "woman's purse on the floor",
      "man on a pedestal",
    ],
    "i sold all my": [
      "stones animal crossing",
      "bitcoin",
      "stocks",
      "thieves guild armor",
      "stuff",
      "video games",
      "weeds animal crossing",
      "furniture",
      "money",
      "xrp",
    ],
    ...
    "i broke my": [
      "back",
      "butt",
      "heart loving you book",
      "trunk",
      "own water",
      "water with a crochet hook",
      "wife's heart how do i fix it",
      "leg can i get unemployment",
      "heart loving you",
      "toe",
    ],
    "i smell": [
    ...
    "my eyes look": [
      ...
      "yellow",
      "dead",
      "half closed in pictures",
      "glassy",
      "weird on facetime",
      "different",
      "a little yellow",
      "smaller without glasses",
    ],
    "my feet smell like": [
      "fritos",
      "ammonia",
    ...
    "i lied to my": [
      "boyfriend how do i fix it",
      "boyfriend",
      "girlfriend",
      "wife how do i fix it",
      "girlfriend how do i fix it",
      "partner",
      "boss what do i do",
      "boss about being sick",
      "girlfriend about my past",
    ...
    "my car is": [
      ...
      "leaking oil",
      "overheating",
      "leaking oil from the front",
      "not starting",
      "smoking under the hood",
      "making a whining noise",
      "leaking water from the bottom",
      "jerking when i drive",
      "making a funny noise",
    ],
    "my dog has": [
      "diarrhea",
      "diarrhea but is acting fine",
      "bumps under her fur",
      "dry flaky skin and scabs",
      "crusty scabs on his back",
      "to sleep touching me",
    ...
    megan: [
      ...
      "thee stallion",
      "anderson",
      "thee stallion height",
      "boone",
      "thee stallion pardison",
      "thee stallion net worth",
      "fox age",
      "rapinoe",
    ],
    marie: [
    ...
    "why does my arm": [
      "hurt",
      "hurt after a flu shot",
      "hurt after a shot",
      "feel numb",
      "keep twitching",
      "fall asleep at night",
      "feel weak",
      "go numb when i sleep",
      "keep falling asleep",
      "hurt when i sneeze",
    ],
    ...
    "should i stop": [
      ...
      "smoking weed",
      "drinking coffee",
      "my dog from eating grass",
      "paying my student loans",
      "smoking if i have covid",
      "drinking",
      "playing video games",
      "texting her",
      "texting him",
    ...
    "do astronauts": [
      ...
      "drink their own pee",
      "shower in space",
      "have periods in space",
      "get paid for life",
      "get taller in space",
      "shower",
      "get paid",
      "drink alcohol in space",
    ],
    "do cats": [
      "fart",
      "see color",
